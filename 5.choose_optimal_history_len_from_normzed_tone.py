...
pd.DataFrame(performance_dist, columns=['input_option', 'history_len', 'archi', 'iter_no', 'loss', 'accuracy', 'mean squared error']).to_csv("./data/choose_his_len_from_normzed_tone.csv")
